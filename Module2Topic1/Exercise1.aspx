...
<body>
    ...
    <form runat="server">
        ...
        <asp:Label ID="SongLabel" runat="server" Text="Happiness - The 1975"></asp:Label>
        <br />
        ...
        <asp:Image ID="SongAlbumCover" runat="server" ImageUrl="~/being-funny-in-a-foreign-language.jpg" AlternateText="Album Cover of my Favorite Song :>" Width="200" Height="200"/>
        <br />
        ...
        <asp:Button ID="PlayBtn" runat="server" Text="Play" OnClick="playSong"/>
        ...
        <span ID="SongStatus" runat="server"></span>
        <br />
