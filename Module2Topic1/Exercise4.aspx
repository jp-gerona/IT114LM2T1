...
<body>
    ...
    <form runat="server">
        ...
        <asp:RequiredFieldValidator runat="server" ControlToValidate="fullName" ErrorMessage="This field is required."></asp:RequiredFieldValidator>
        <br />
        <br />
        ...
        <asp:RangeValidator runat="server" ControlToValidate="age" Type="Integer" MinimumValue="0" MaximumValue="100" ErrorMessage="Please enter a valid age (0-100)" />
        <br />
        <br />
        ...
        <asp:CompareValidator runat="server" ControlToValidate="confirmEmail" ControlToCompare="email" Operator="Equal" Type="String" ErrorMessage="Email addresses do not match." />
        <br />
        <br />
